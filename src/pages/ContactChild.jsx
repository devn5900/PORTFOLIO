...
import { BsGithub, BsLinkedin, BsPerson, BsPhoneFill } from "react-icons/bs";
...
export default function ContactChild() {
  const { hasCopied, onCopy } = useClipboard("devn5900@gmail.com");
          ...
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            ...
            >
              <Stack
                ...
                p={["0.3rem", "1rem"]}
              >
                <Link href="https://github.com/devn5900" target="_blank">
                  <Flex
                    alignItems={"center"}
                    id="contact-github"
                    minW={"10rem"}
                ...
                <Link
                  href="https://www.linkedin.com/in/devesh-kumar-mishra-58b481152/"
                  target="_blank"
                >
                  <Flex
                    alignItems={"center"}
                ...
                <Link href="tel:+918381947034">
                  <Flex alignItems={"center"} id="contact-phone" minW={"10rem"}>
                    <IconButton
                      aria-label="phone"
                      variant="ghost"
                      size="lg"
                      icon={<BsPhoneFill size="28px" />}
                      _hover={{
                        bg: "blackAlpha.900",
                        color: useColorModeValue("white", "gray.700"),
                      }}
                ...
                <Link href="mailto:devn5900@gmail.com">
                  <Flex alignItems={"center"} id="contact-email" minW={"10rem"}>
                    <Tooltip
